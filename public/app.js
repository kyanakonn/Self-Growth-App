...
function dailyAIComment(grade) {
  const comments = {
    A: [
      ...
      "戦略的にも量的にも申し分ありません。素晴らしい内容です。"
    ],
    B: [
      "全体として良好ですが、もう少しで一段階上を目指せます。",
      "学習習慣は安定しています。少し内容について考えてみましょう。",
    ...
    C: [
      ...
      "今の状況ではやや量・質ともに不足気味です。",
      "まずは毎日の学習時間を安定させましょう。",
      "合格者平均との差はまだあります。焦らず積み上げが必要です。",
    ],
    D: [
      "学習量が不足しています。計画の見直しが必要です。",
      "継続性がカギです。短時間でも毎日を意識しましょう。",
      "今の状態では合格戦略として不十分な内容です。",
      "この状態が続くとどんどん差が開いてしまいます。",
      "まずは30分でも学習時間を確保してください。"
    ],
    E: [
      "学習記録がほとんどありません。学習を始めましょう。",
      "今の状態では合格者との差が大きく開いてしまいます。",
      "今の状態の学習内容では最低評価です。",
      "まずは机に向かって学習しましょう。",
      "さぁ、今日の学習を始めましょう。"
    ]
...
function monthlyAIComment(grade) {
  const comments = {
    ...
    B: "良い月ですが、継続できれば確実な合格が見えてきます。",
    C: "可もなく不可もなく。学習量アップが必須です。",
    D: "学習時間が足りません。月前半を有効に使いましょう。",
    E: "今月の勉強を始めましょう。"
  };
  return comments[grade] || "";
}
